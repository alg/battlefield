...
(((window, undefined) => {
    ...
    var // The functions to execute on DOM ready
    readyList = [];
    ...
    var rnamespaces = /\.(.*)$/;
    var fcleanup = nm => nm.replace(/[^\w\s\.\|`]/g, ch => "\\" + ch);
    ...
    jQuery.event = {
        ...
        trigger(event, data, elem /*, bubbling */) {
            ...
            if ( !event.isPropagationStopped() && parent ) {
                ...
                var old;
                var isClick = jQuery.nodeName(target, "a") && type === "click";
                var special = jQuery.event.special[ type ] || {};
        ...
        special: {
            ...
            live: {
                ...
                remove(handleObj) {
                    var remove = true;
                    var type = handleObj.origType.replace(rnamespaces, "");
    ...
    ((() => {
        ...
        for ( var type in Expr.match ) {
            ...
            Expr.leftMatch[ type ] = new RegExp( /(^(?:.|\r|\n)*?)/.source + Expr.match[ type ].source.replace(/\\(\d+)/g, (all, num) => "\\" + (num - 0 + 1)));
        }
        ...
        var contains = document.compareDocumentPosition ? (a, b) => !!(a.compareDocumentPosition(b) & 16) : (a, b) => a !== b && (a.contains ? a.contains(b) : true);
    ...
    var winnow = (elements, qualifier, keep) => {
        if ( jQuery.isFunction( qualifier ) ) {
            return jQuery.grep(elements, (elem, i) => !!qualifier.call( elem, i, elem ) === keep);
    ...
    var fcloseTag = (all, front, tag) => rselfClosing.test( tag ) ?
        all :
        front + "></" + tag + ">";
    ...
    var // cache check for defaultView.getComputedStyle
    getComputedStyle = document.defaultView && document.defaultView.getComputedStyle;

    var // normalize float css property
    styleFloat = jQuery.support.cssFloat ? "cssFloat" : "styleFloat";

    var fcamelCase = (all, letter) => letter.toUpperCase();

    jQuery.fn.css = function( name, value ) {
        return access( this, name, value, true, (elem, name, value) => {
            if ( value === undefined ) {
    ...
    jQuery.extend({
        ...
        ajax(origSettings) {
            ...
            var onreadystatechange = xhr.onreadystatechange = isTimeout => {
    ...
    jQuery.fn.extend({
        ...
        animate(prop, speed, easing, callback) {
            ...
            return this[ optall.queue === false ? "each" : "queue" ](function() {
                ...
                var p;
                var hidden = this.nodeType === 1 && jQuery(this).is(":hidden");
                var self = this;
    ...
    if ( "getBoundingClientRect" in document.documentElement ) {
        jQuery.fn.offset = function( options ) {
            ...
            var top  = box.top  + (self.pageYOffset || jQuery.support.boxModel && docElem.scrollTop  || body.scrollTop ) - clientTop;
            var left = box.left + (self.pageXOffset || jQuery.support.boxModel && docElem.scrollLeft || body.scrollLeft) - clientLeft;
    ...
    jQuery.offset = {
        initialize() {
            ...
            var table;
            var td;
            var bodyMarginTop = parseFloat( jQuery.curCSS(body, "marginTop", true) ) || 0;
        ...
        setOffset(elem, options, i) {
            ...
            var curTop    = parseInt( jQuery.curCSS( elem, "top",  true ), 10 ) || 0;
            var curLeft   = parseInt( jQuery.curCSS( elem, "left", true ), 10 ) || 0;
    ...
    jQuery.fn.extend({
        position() {
            ...
            var parentOffset = /^body|html$/i.test(offsetParent[0].nodeName) ? { top: 0, left: 0 } : offsetParent.offset();
