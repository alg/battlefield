...
Rules.turnRate = velocity => Rules.maxTurnRate - 0.75 * velocity

// Energy taken when a tank hits a wall with a specific velocity.
Rules.wallHitDamage = velocity => Math.max(Math.abs(velocity) / 2 - 1, 0)

// Damage of a bullet at a specific power.
Rules.bulletDamage = bulletPower => {
...
Rules.bulletHitBonus = bulletPower => 3 * bulletPower

// Speed of a bullet depending on its power.
Rules.bulletSpeed = bulletPower => 20 - 3 * bulletPower
